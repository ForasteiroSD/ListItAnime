...
function Animes() {
  ...
  async function getThisSeasonAnimes() {
    ...
    const timeout = setTimeout(async () => {
      const response = await Axios.get("https://list-it-anime-dudh.vercel.app/animes");
  ...
  async function searchAnimes() {
    ...
    const timeout = setTimeout(async () => {
      const response = await Axios.get("https://list-it-anime-dudh.vercel.app/search?name=" + buffer.replaceAll(" ", "+"));
